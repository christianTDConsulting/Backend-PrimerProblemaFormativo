...
//const knowledgeJSON = fs.readFileSync('./src/assets/catalogo.json', 'utf-8');
...
Mi enfoque es proporcionar respuestas claras y precisas, equilibrando formalidad y coloquialismo para ser amigable y generar confianza.
...
En cuestiones de stock, informaré si hay 'suficiente' o 'poco stock' (25 unidades o menos), incentivando la compra en este último caso.  Pero nunca diré el número de stock, solo si queda mucho o poco. 
...
//const roleSystem = {"role": "system", "content":instructions}; 
...
export { openai,  generateAssistant };